 ...
 * Features:
 * - Card 1: Net Inflow metric with percentage increase (+ sign in Rupees)
    ...
    <div className={`w-full space-y-3 select-none ${className}`}>
      ...
      <div className="space-y-2.5">
        ...
        <div className="w-full rounded-3xl bg-white dark:bg-[#161B22] border border-slate-200/80 dark:border-[#30363D] p-4 shadow-sm hover:shadow-md transition-all flex items-center justify-between gap-3">
          ...
          {/* Ratio Status */}
          <div className="text-[11px] sm:text-xs font-extrabold font-mono text-slate-700 dark:text-slate-200 px-2.5 py-1 rounded-xl bg-slate-100 dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700">
            {taxRatioPercent}% Safe
          </div>
        </div>
