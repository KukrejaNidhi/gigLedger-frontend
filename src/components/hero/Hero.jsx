...
export const HeroCommandHeader = ({
  ...
  return (
    <div className={`w-full bg-white dark:bg-slate-900 p-5 rounded-3xl border border-slate-200 dark:border-slate-800 space-y-4 shadow-sm hover:shadow-md transition-all ${className}`} {...rest}>
...
export const MetricBentoGrid = ({
  metrics = [
    { label: 'Gross Inflow', value: '₹64,200.00', subLabel: 'Consolidated', variant: 'sky' },
    { label: 'Tax Reserve', value: '₹11,200.00', subLabel: '23% Protected', variant: 'coral' },
    { label: 'Deductibles', value: '₹15,700.00', subLabel: 'Sec 44ADA', variant: 'olive' },
    { label: 'Shift Yield', value: '42 km', subLabel: 'Tracked Mileage', variant: 'steel' },
  ],
  columns = 2,
  className = '',
  ...rest
...
export const ShiftCalendarStrip = ({
  ...
  return (
    <div className={`w-full bg-white dark:bg-slate-900 p-3.5 rounded-2xl border border-slate-200 dark:border-slate-800 space-y-2 shadow-sm hover:shadow-md transition-all ${className}`} {...rest}>
